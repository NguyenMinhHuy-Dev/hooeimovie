                ...
                <>
                    <div className="trailer-content">   
                        <iframe
                            ...
                            width="100%" 
                            type="text/html"
                            src={`https://www.youtube.com/embed/${trailer.key}?autoplay=1&mute=0&loop=1&color=white&iv_load_policy=3&modestbranding=1&playsnline=1&rel=0&controls=0&enablejsapi=1&showinfo=0&playlist=${trailer.key}`}
